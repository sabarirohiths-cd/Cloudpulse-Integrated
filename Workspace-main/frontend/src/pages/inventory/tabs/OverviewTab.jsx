    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-4 gap-4">
        ...
        <div className="bg-zinc-900/50 border border-zinc-800/50 rounded-xl p-5">
          ...
          {donut.length > 0 ? (
            <>
              <CustomDonut data={donut} colors={COLORS} isAnimationActive={!pieGroupFilter} provider={topFilters.provider} onSliceClick={(sliceName) => {
                if (!pieGroupFilter) {
        ...
        <div className="bg-zinc-900/50 border border-zinc-800/50 rounded-xl p-5">
          ...
          {tagDonut && (tagDonut[0].value > 0 || tagDonut[1].value > 0) ? (
            <>
              <CustomDonut data={tagDonut} colors={['#10b981', '#52525b']} provider={topFilters.provider} />
      ...
      <ActivityHeatmap account={selectedAccount} crossFilterType={crossFilterType} provider={topFilters.provider} />
    </div>
  );
}
